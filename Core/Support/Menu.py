...
class Main:
    ...
    @staticmethod
    def Checker():
        if not os.path.exists("Configuration/Agreement.txt"):
    ...
    def banner():
        ...
        with open(f"Quotes/{choice}", "r", newline=None) as f:
            text = f.read()
        print(
            f"{Font.Color.WHITE}---------------------------------------------------------------------"
        )
        ...
        print(
            f"{Font.Color.WHITE}|[+]{Font.Color.GREEN}VERSION:{version}{Font.Color.WHITE}                                             |"
        )
        print(
    ...
    def Mobile_Banner():
        ...
        print(Font.Color.GREEN + text)
        print(
            f"{Font.Color.WHITE}A COMPLETE OSINT TOOL:)      {Font.Color.BANNER}CODED BY LUCKSI{Font.Color.RESET}"
        )
                    ...
                    print(
                        (
                            ...
                            + Language.Translation.Translate_Language(
                                filename, "Default", "KeyError", "None"
                            )
                        )
                    )
                    exit()
                ...
                print(
                    (
                        (
                            f"{Font.Color.RED}[!]{Font.Color.WHITE}"
                            + Language.Translation.Translate_Language(
                                filename, "Default", "ValueError", "None"
                            )
                        )
                        + f"{str(e)}"
                    )
